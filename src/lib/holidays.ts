// ============================================================================
// Gesetzliche Feiertage in Nordrhein-Westfalen – der Laden liegt in Hürth (50354),
// also Nordrhein-Westfalen. Bewegliche Feiertage werden über die Osterformel
// (Gauß/Computus) berechnet.
//
// Besonderheit Nordrhein-Westfalen (LFtG): katholisch geprägt – es gelten
...
/** Datum -> Name aller gesetzlichen Feiertage in Nordrhein-Westfalen eines Jahres. */
export function publicHolidayNames(year: number): Map<string, string> {
  ...
  map.set(iso(addDays(easter, 60)), "Fronleichnam"); // Nordrhein-Westfalen
  map.set(iso(new Date(year, 9, 3)), "Tag der Deutschen Einheit");
  map.set(iso(new Date(year, 10, 1)), "Allerheiligen"); // Nordrhein-Westfalen, 01.11.
...
/**
 * Alle gesetzlichen Feiertage in Nordrhein-Westfalen eines Jahres als ISO-Set
